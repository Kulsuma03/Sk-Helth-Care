...
const Header = () => {
    ...
    return (
        <div className={`px-4 py-5 sticky top-0 z-50  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 ${!navbar ? "bg-transparent text-white" : "bg-blue-500 text-gray-700"}`}>
            <div className="relative flex items-center justify-between">
                ...
                >
                    <FaHeartbeat className='text-red-900 text-2xl'></FaHeartbeat>
